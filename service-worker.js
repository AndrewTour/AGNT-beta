const CACHE='agnt-v1.29.4';
const ASSETS=['./','./index.html','./styles.css?v=v1.29.4-pace-prospector-refine','./app.js?v=v1.29.4-pace-prospector-refine','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
