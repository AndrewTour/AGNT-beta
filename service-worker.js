const CACHE='agnt-v126-4-prospecting-intelligence';
const ASSETS=['./','./index.html','./styles.css?v=126.4-prospecting-intelligence','./app.js?v=126.4-prospecting-intelligence','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
