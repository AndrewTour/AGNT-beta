const CACHE='agnt-v1.29.2';
const ASSETS=['./','./index.html','./styles.css?v=v1.29.2-premium-polish','./app.js?v=b20-buyer-list-session-1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
