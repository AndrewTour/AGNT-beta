const CACHE='agnt-beta-v1.35.0-team-rollout';
const ASSETS=['./','./index.html','./styles.css?v=1.35.0-beta-team-rollout','./app.js?v=1.35.0-beta-team-rollout','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
