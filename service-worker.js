const CACHE='agnt-beta-v1.36.19-buyer-card-hierarchy';
const ASSETS=['./','./index.html','./styles.css?v=1.36.19-beta-buyer-card-hierarchy','./app.js?v=1.36.19-beta-buyer-card-hierarchy','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
