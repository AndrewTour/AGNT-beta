const CACHE='agnt-v119-9-hot-spotting-cards';
const ASSETS=['./','./index.html','./styles.css?v=119.8-hot-spotting-flow','./app.js?v=119.8-hot-spotting-flow','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
