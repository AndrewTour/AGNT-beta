const CACHE='agnt-v1.30.0';
const ASSETS=['./','./index.html','./styles.css?v=v1.30.0-dark-mode','./app.js?v=v1.30.0-dark-mode','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
