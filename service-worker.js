const CACHE='agnt-beta-v1.36.18-buyer-visual-fix';
const ASSETS=['./','./index.html','./styles.css?v=1.36.18-beta-buyer-visual-fix','./app.js?v=1.36.18-beta-buyer-visual-fix','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
