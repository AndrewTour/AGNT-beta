const CACHE='agnt-v127-2-session-lifecycle';
const ASSETS=['./','./index.html','./styles.css?v=127.2-session-lifecycle','./app.js?v=127.2-session-lifecycle','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
