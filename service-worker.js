const CACHE='agnt-beta-v1.35.1-delete-team';
const ASSETS=['./','./index.html','./styles.css?v=1.35.1-beta-delete-team','./app.js?v=1.35.1-beta-delete-team','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
