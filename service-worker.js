const CACHE='agnt-v1.29.3';
const ASSETS=['./','./index.html','./styles.css?v=v1.29.3-targeted-fixes','./app.js?v=v1.29.3-targeted-fixes','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
