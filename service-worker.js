const CACHE='agnt-b19-hotspot-callflow-back-fix-1';
const ASSETS=['./','./index.html','./styles.css?v=b19-hotspot-callflow-back-fix-1','./app.js?v=b19-hotspot-callflow-back-fix-1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
