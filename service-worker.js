const CACHE='agnt-v1.31.1';
const ASSETS=['./','./index.html','./styles.css?v=1.31.1','./app.js?v=1.31.1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
