const CACHE='agnt-v1.29.1';
const ASSETS=['./','./index.html','./styles.css?v=v1.29.1-crux-refine','./app.js?v=b20-buyer-list-session-1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
