const CACHE='agnt-v1.30.14';
const ASSETS=['./','./index.html','./styles.css?v=1.30.14','./app.js?v=1.30.14','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
