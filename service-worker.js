const CACHE='agnt-v126-3-broadcast-ui-alignment';
const ASSETS=['./','./index.html','./styles.css?v=126.3-broadcast-audiences','./app.js?v=126.3-broadcast-audiences','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
