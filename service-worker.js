const CACHE='agnt-b19-listings-2';
const ASSETS=['./','./index.html','./styles.css?v=b19-listings-2','./app.js?v=b19-listings-2','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
