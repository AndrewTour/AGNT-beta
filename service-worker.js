const CACHE='agnt-v1.30.6';
const ASSETS=['./','./index.html','./styles.css?v=1.30.6','./app.js?v=1.30.6','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
