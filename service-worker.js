...
const ASSETS=['./','./index.html','./styles.css?v=126.8-broadcast-step-flow','./app.js?v=126.8-broadcast-step-flow','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
