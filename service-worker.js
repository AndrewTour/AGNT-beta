const CACHE='agnt-v126-8-broadcast-step-flow';
const ASSETS=['./','./index.html','./styles.css?v=126.9-broadcast-fullscreen','./app.js?v=126.9-broadcast-fullscreen','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
