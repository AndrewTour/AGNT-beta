const CACHE='agnt-v1.31.0';
const ASSETS=['./','./index.html','./styles.css?v=1.31.0','./app.js?v=1.31.0','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
