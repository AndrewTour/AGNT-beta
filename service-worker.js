const CACHE='agnt-v126-0-bulk-sms-test';
const ASSETS=['./','./index.html','./styles.css?v=126.0-bulk-sms-test','./app.js?v=126.0-bulk-sms-test','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
