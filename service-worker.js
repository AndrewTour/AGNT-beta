const CACHE='agnt-b26-appointment-invites-2';
const ASSETS=['./','./index.html','./styles.css?v=b26-appointment-invites-1','./app.js?v=b26-appointment-invites-1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
