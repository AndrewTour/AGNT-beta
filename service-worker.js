const CACHE='agnt-v119-11-hotspot-dropdown';
const ASSETS=['./','./index.html','./styles.css?v=119.12-hotspot-dropdown','./app.js?v=119.12-hotspot-dropdown','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
