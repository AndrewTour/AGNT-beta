const CACHE='agnt-v125-8-hotspot-sms';
const ASSETS=['./','./index.html','./styles.css?v=125.8-hotspot-sms','./app.js?v=125.8-hotspot-sms','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
